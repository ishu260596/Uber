...
import com.masai.uber_rider.databinding.ActivityPhoneVerificationBinding
...
class PhoneVerificationActivity : AppCompatActivity() {
    ...
    private fun redirect() {
        PreferenceHelper.writeStringToPreference(KEY_PASSENGER_MOBILE_NUMBER, mobileNumber)
        startActivity(
